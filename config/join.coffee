module.exports =
    description:"""
    # How can I help?
    ## If you are a post-secondary student in the area you can join us for any of the discipline meetings listed below. As a members you are encouraged to work on the systems that interest you and not necessairily the one that corresponds to your discipline.
    ## Also, dont be shy or intimidated we enjoy helping individuals of all skill levels develop the same passion for aeronautics that we have.
