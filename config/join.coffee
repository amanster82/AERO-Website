module.exports =
    description:"""With a complex system such as a UAV, you need to bring minds of many displines together in order to bring a design to life. Although each member of our team comes from a particular faculty/disipline, our responsibilities are not tired to our existing knowledge. Members are encouraged to work on the systems that interest them, to push their boundaries and learn something new. Below, broken up by field, are the various tasks and activities members can expect to partake in.
    """
    teams: [
        name: "Aeronautical Engineering"
        description: "The aeronautical engineering component of the team involves the design and construction of the unmanned aerial vehicle (UAV). Aircraft designs are created using CAD software and modelled using Computational Fluid Dynamics (CFD). Construction of the airframe involves CNC milling and custom molding from Kevlar and carbon fiber. Further aeronautical engineering development of the UAV involves flight testing and installation of control surfaces and motors for flight."
    ,
